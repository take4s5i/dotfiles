...
vim.keymap.set('n', '<leader>l', ':Setloclist<CR>', { noremap = true, silent = true })
vim.keymap.set('n', '<leader>C', ':copen<CR>', { noremap = true, silent = true })
vim.keymap.set('n', '<leader>c', ':Setqflist<CR>', { noremap = true, silent = true })
...
vim.keymap.set('n', '<C-g>', function() vim.diagnostic.setqflist() end, { silent = true })
