# --------------------------------------------
# originated by https://github.com/go-task/task/blob/main/completion/fish/task.fish
# --------------------------------------------

set GO_TASK_PROGNAME t

function __task_get_tasks --description "Prints all available tasks with their description"
  # Read the list of tasks (and potential errors)
  task -t ~/.config/taskfile.yaml --list-all 2>&1 | read -lz rawOutput
